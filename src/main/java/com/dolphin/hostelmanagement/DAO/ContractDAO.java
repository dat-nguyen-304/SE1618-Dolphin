...
public class ContractDAO {
    ...
    public static Contract findCurrentContractByTenantID(int tenantID) {
        Connection cn = null;
        ...
        try {
            ...
            if (rs != null && rs.next()) {
                ...
                c = new Contract(contractID, room, tenant, landlord, hostel, startDate, endDate, deposit, status, rentalFee, description, duration);
            }
    ...
    public static boolean save(Contract c) {
        ...
        try {
            ...
            String sql = "Insert into Contract(contractID, roomID, tenantID, startDate, endDate, status, rentalFeePerMonth, deposit, description, duration)"
                    + "values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
