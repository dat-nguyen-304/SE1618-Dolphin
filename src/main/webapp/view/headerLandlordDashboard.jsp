                            ...
                            <div id="toast-notification"
                                ...
                                <div class="flex items-center">
                                    <div class="relative inline-block shrink-0">
                                        <img class="w-12 h-12 rounded-full" src="${empty sessionScope.currentUser.account.avatar ? "/sakura/assets/images/user-avatars/no_ava.jpg" : sessionScope.currentUser.account.avatar}"
                                             alt="" />
                                    </div>
                                    <div class="ml-3 text-sm font-normal">
                                        <h4 class="text-sm font-semibold text-gray-900 ">${sessionScope.currentUser.fullname}</h4>
            ...
            <div class="relative">
                ...
                <div id="dropdown"
                    ...
                    <div class="px-4 py-3 text-sm text-gray-900">
                        <div>${sessionScope.currentUser.fullname} - Chủ nhà</div>
