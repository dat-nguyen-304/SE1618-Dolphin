        ...
        <ul class="space-y-2">
            <li class="">
                <a href="/sakura/landlord/overview"
                   class="${(pageContext.request.requestURI == '/sakura/view/LOverView.jsp') ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-slate-300 rounded hover:bg-[#17535B] hover:text-slate-100 group">
            ...
            <li class="">
                <a href="/sakura/landlord/hostel-info"
                   class="${requestPath == '/sakura/landlord/hostel-info' ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-slate-300 rounded hover:bg-[#17535B] hover:text-slate-100 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-slate-300 transition duration-75 group-hover:text-slate-100" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M2 5a2 2 0 012-2h8a2 2 0 012 2v10a2 2 0 002 2H4a2 2 0 01-2-2V5zm3 1h6v4H5V6zm6 6H5v2h6v-2z" clip-rule="evenodd" />
                        <path d="M15 7h1a2 2 0 012 2v5.5a1.5 1.5 0 01-3 0V7z" />
                    </svg>
                    <span class="ml-3">Thông tin nhà trọ</span>
                </a>
            </li>
            <li class="menu-item">
                <button type="button"
            ...
            <li>
                <a href="/sakura/landlord/contract-list"
                   class="${(requestPath == '/sakura/landlord/contract-list' || requestPath == '/sakura/landlord/contract-detail') ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-slate-300 rounded hover:bg-[#17535B] hover:text-slate-100 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-slate-300 transition duration-75 group-hover:text-slate-100" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li class="menu-item">
                <button type="button"
                        class="${(requestPath == '/sakura/invoice/list' || requestPath == '/sakura/landlord/invoice-list' || requestPath == '/sakura/invoice/detail' || requestPath == '/sakura/invoice/new' || requestPath == '/sakura/invoice/success' || requestPath == '/sakura/invoice/failure') ? 'parent-active' : ''} flex items-center p-2 w-full text-base font-normal text-slate-300 rounded transition duration-75 group hover:bg-[#17535B] hover:text-slate-100"
                ...
                <ul id="dropdown-invoice" class="${(requestPath == '/sakura/invoice/list' || requestPath == '/sakura/invoice/detail' || requestPath == '/sakura/invoice/new' || requestPath == '/sakura/invoice/success' || requestPath == '/sakura/invoice/failure') ? '' : 'hidden'}  py-2 space-y-2">
                    <li>
                        <a href="/sakura/invoice/list"
                           class="${(requestPath == '/sakura/invoice/list' || requestPath == '/sakura/invoice/detail') ? 'active' : ''} menu-item flex items-center p-2 pl-11 w-full text-base font-normal text-slate-300 rounded transition duration-75 hover:bg-[#17535B] hover:text-slate-100">
                            Danh sách hoá đơn
                        </a>
                    </li>
                    <li>
                        <a href="/sakura/invoice/new" id="list-item"
                           class="${(requestPath == '/sakura/invoice/new' || requestPath == '/sakura/invoice/success' || requestPath == '/sakura/invoice/failure') ? 'active' : '' }  menu-item flex items-center p-2 pl-11 w-full text-base font-normal text-slate-300 rounded transition duration-75 hover:bg-[#17535B] hover:text-slate-100">
                            Thêm hóa đơn
                        </a>
                    </li>
                </ul>
            ...
            <li>
                <a href="/sakura/landlord/revenue-list" class="${(requestPath == '/sakura/landlord/revenue-list' || requestPath == '/sakura/landlord/revenue-detail') ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-slate-300 rounded hover:bg-[#17535B] hover:text-slate-100 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-slate-300 transition duration-75 group-hover:text-slate-100" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li>
                <a href="/sakura/landlord/service"
                   class="${requestPath == '/sakura/landlord/service' ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-slate-300 rounded hover:bg-[#17535B] hover:text-slate-100 group">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-slate-300 transition duration-75 group-hover:text-slate-100" viewBox="0 0 20 20" fill="currentColor">
