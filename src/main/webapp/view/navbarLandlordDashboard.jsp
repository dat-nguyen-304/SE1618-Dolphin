        ...
        <ul class="space-y-2">
            ...
            <li class="">
                <a href="/sakura/landlord/hostel-info"
                   class="${requestPath == '/sakura/landlord/hostel-info' ? 'active' : ''} menu-item flex items-center p-2 text-base font-normal text-[#929CA5] rounded hover:bg-[#F3F3F3] hover:text-[#17535B] group">
            ...
            <li class="menu-item">
                <button type="button"
                        class="${(requestPath == '/sakura/landlord/invoice-list' || requestPath == '/sakura/invoice/new') ? 'parent-active' : ''} flex items-center p-2 w-full text-base font-normal text-[#929CA5] rounded transition duration-75 group hover:bg-[#F3F3F3] hover:text-[#17535B]"
                ...
                <ul id="dropdown-invoice" class="${(requestPath == '/sakura/landlord/invoice-list' || requestPath == '/sakura/invoice/new') ? '' : 'hidden'}  py-2 space-y-2">
                    <li>
                        <a href="/sakura/landlord/invoice-list"
                           class="${requestPath == '/sakura/landlord/invoice-list' ? 'active' : ''} menu-item flex items-center p-2 pl-11 w-full text-base font-normal text-[#929CA5] rounded transition duration-75 hover:bg-[#F3F3F3] hover:text-[#17535B]">
                            Danh sách hoá đơn
                        </a>
                    </li>
                    <li>
                        <a href="/sakura/invoice/new" id="list-item"
                           class="${requestPath == '/sakura/invoice/new' ? 'active' : ''}  menu-item flex items-center p-2 pl-11 w-full text-base font-normal text-[#929CA5] rounded transition duration-75 hover:bg-[#F3F3F3] hover:text-[#17535B]">
                            Thêm hóa đơn
                        </a>
                    </li>
                </ul>
