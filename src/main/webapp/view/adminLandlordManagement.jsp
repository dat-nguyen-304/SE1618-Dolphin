...
<html>
    <head>
        ...
        <title>Admin - Quản lý chủ nhà</title>
        ...
        <div class="ml-[256px] my-0 h-fit overflow-hidden bg-[#f9fafb]">
            ...
            <div class="h-full px-[20px] pt-[calc(60px+20px)] pb-[20px]">
                ...
                <div class="card bg-[#fff] p-[20px] mt-[20px] h-[calc(100vh-220px)]">
                    <table id="landlord-table" class="w-full text-[16px] text-left text-gray-600 border-[1px] border-gray-100 relative">
                        ...
                        <tbody>
                            <c:forEach items = "${requestScope.landlordList}" var = "landlord">
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    ...
                                    <td class="text-center px-6 py-[5px]">${landlord.phone}</td>
                                    <td class="text-center px-6 py-[5px]">${landlord.account.registrationDate}</td>
                                    ...
                                    <td class="text-left px-6 py-[5px] flex items-center justify-around">
                                        ...
                                        <form action="/sakura/admin/landlord-detail">
                                            <button name="accountID" value="${landlord.account.accountID}" class="w-[120px] text-center bg-[#fff] border border-gray-300 hover:border-[#17535B] text-gray-500 py-[3px] font-medium rounded">
