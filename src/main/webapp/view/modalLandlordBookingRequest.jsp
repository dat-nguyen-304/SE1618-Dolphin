<%-- 
    Document   : modalLandlordBookingRequest
    Created on : Jul 31, 2022, 1:48:27 PM
    Author     : Nguyen Dang Loc <locndse160199@fpt.edu.vn>
--%>


<!--Modal confirm deny request-->
<div class="confirmDenyRequest opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center z-[1000]">
    <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
    <div class="modal-container bg-white w-1/3 mx-auto rounded shadow-lg z-50 overflow-y-auto">
        <div class="confirmDenyRequest-close absolute top-0 right-0 cursor-pointer flex flex-col items-center mt-4 mr-4 text-white text-sm z-50">
        ...
        <div class="modal-content">
            ...
            <div class="flex justify-between items-center p-[20px] py-[10px] border-b">
                ...
                <div class="confirmDenyRequest-close cursor-pointer z-50 rounded-full p-[10px] hover:bg-[#F2F7F9]">
            ...
            <form method="POST" action="/sakura/landlord/rentalRequestList" >
                ...
                <div class="p-[20px]">
                    ...
                    <h3 class="text-[20px] font-semibold text-gray-800">Bạn chắc chắn từ chối yêu cầu thuê phòng <b>${booking.roomType.roomTypeName}</b> của <b>${booking.tenant.fullname}</b>?</h3>
...
<!--End modal confirm deny request-->