                            ...
                            <div id="toast-notification"
                                ...
                                <div class="flex items-center">
                                    <div class="relative inline-block shrink-0">
                                        <img class="w-12 h-12 rounded-full" src="${empty sessionScope.currentUser.avatar ? "/sakura/assets/images/user-avatars/no_ava.jpg" : sessionScope.currentUser.avatar}"
                                             alt="" />
                                    </div>
                                    <div class="ml-3 text-sm font-normal">
                                        <h4 class="text-sm font-semibold text-gray-900 ">${sessionScope.currentUser.username}</h4>
