    ...
    <body>
        ...
        <div class="bg-slate-50 h-screen w-screen flex">
            ...
            <div class="w-3/5 h-full pt-[4%] pb-[6%] px-[6%]">
                <form class="login-form flex flex-col justify-center items-center w-full h-full" action="#" method="post" id="registerForm" name="login-form">
                    ...
                    <ul class="item-list list-none w-3/5">
                        ...
                        <li>
                            <button type="submit" id="login-btn" class="w-full h-1/5 mx-auto rounded px-5 py-3 min-w-max overflow-hidden shadow relative bg-[#17535B] text-white hover:bg-opacity-[95%]" name="action" value="Register" onclick="return validate()">Đăng ký</button>  
                        </li>
                        <li class="mt-8">
