                ...
                <form class="login-form flex flex-col justify-center items-center w-full h-full" action="/sakura/access/register" method="post"  id="form" name="login-form">
                    ...
                    <ul class="item-list list-none w-3/5">
                        ...
                        <li class="item relative">
                            <input type="text" class="input-field peer placeholder-transparent" id="fullname" name="fullname" placeholder="Full name" required/>
                        ...
                        <!--User name-->
                        <li class="item relative">
                            <input type="text" class="input-field peer placeholder-transparent" id="username" name="username" placeholder="User name" value="" onchange="checkUsername()" required/>
                            <p id="error" class="warning font-light absolute right-0">Tên đăng nhập không chứa các kí tự đặc biệt (trừ '_')</p>
                        ...
                        <!--Email-->
                        <li class="item relative">
                            <input type="email" class="input-field peer placeholder-transparent" id="email" name="email" placeholder="Email" value="" required/>
                            <p class="warning font-light absolute right-0">Sai định dạng email!</p>
                        ...
                        <!--Phone-->
                        <li class="item relative">
                            <input type="text" class="input-field peer placeholder-transparent" id="phone" name="phone" placeholder="Phone" value="" required/>
                        ...
                        <li class="item relative password-input">
                            <input type="password" class="input-field peer placeholder-transparent pr-9" id="password" name="password" placeholder="Password" required/>
                            <p class="warning font-light absolute right-0">${requestScope.warning}</p>
                        ...
                        <li class="item relative password-input mb-3">
                            <input type="password" class="input-field peer placeholder-transparent pr-[36px]" id="cf-password" name="cf-password" placeholder="Confirm password" required/>
