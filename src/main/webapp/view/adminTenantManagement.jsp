...
<html>
    ...
    <body>
        ...
        <div class="ml-[256px] my-0 h-fit overflow-hidden bg-[#f9fafb]">
            ...
            <div>
                <table id="tenant-table" class="w-full text-sm text-left text-gray-500">
                    <thead>
                    ...
                    <tbody>
                        <c:forEach items = "${requestScope.tenantList}" var = "tenant">
                            <tr class="bg-white border-b">
                                ...
                                <td class="text-left px-6 py-4">
                                    ${tenant.account.registrationDate}
                                </td>
                                <td class="text-left px-6 py-4">
                                    <c:if test="${tenant.account.activate == false}">Khóa</c:if>
                                    <c:if test="${tenant.account.activate == true}">Mở</c:if>
                                    </td>
                                ...
                                <td class="text-left px-6 py-4 text-center">
                                    <form action="/sakura/admin/tenant-detail">
                                        <button name="accountID" value="${tenant.account.accountID}"
