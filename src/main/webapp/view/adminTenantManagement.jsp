            ...
            <div class="h-full px-[20px] pt-[calc(60px+20px)] pb-[20px]">
                ...
                <div class="card bg-[#fff] p-[20px] mt-[20px] h-[calc(100vh-220px)]">
                    <div class="mt-[20px] overflow-x-auto">
                        <table id="tenant-table" class="w-full text-[15px] text-left text-gray-500 border-gray-100">
                            <thead>
                                <tr class="text-center text-[15px] text-gray-700 uppercase bg-gray-50">
                            ...
                            <tbody>
                                <c:forEach items = "${requestScope.tenantList}" var = "tenant">
                                    <tr class="bg-white text-[14px] hover:bg-gray-50">
                                        ...
                                        <td class="text-left px-6 py-[5px] flex items-center justify-around">
                                            ...
                                            <form action="/sakura/admin/tenant-detail">
                                                <button name="accountID" value="${tenant.account.accountID}" class="w-[120px] text-center bg-[#fff] border border-gray-300 hover:border-[#17535B] text-gray-500 py-[5px] font-medium rounded"><i class="bi bi-box-arrow-up-right mr-[5px] translate-y-[-5px]"></i>Chi tiết</button>
                                            </form>
                                        </td>
                                    </tr>
                                </c:forEach>
