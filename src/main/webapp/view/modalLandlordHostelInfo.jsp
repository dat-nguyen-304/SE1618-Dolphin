...
<div class="editHostelmodal1 opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center z-[1000]">
    ...
    <div class="modal-container bg-white w-[40%] h-[85%] mx-auto rounded shadow-lg z-50 overflow-y-auto">
        ...
        <div class="modal-content">
            ...
            <div class="p-[20px] w-full">
                ...
                <div class="flex items-start">
                    ...
                    <textarea class="text-[18px] h-[300px] p-[10px] w-[500px] text-clip" required name="updateDescription" id="" rows="5">${sessionScope.currentHostel.description}</textarea>
                </div>
            </div>
            <!--Footer-->
