...
<head>
    ...
    <link rel="stylesheet" href="LContractDetail.css">
            ...
            <div class="grid grid-cols-2 gap-x-8 mt-4 border-2 rounded p-4">
                <div class="">
                    <div class="images border-2 p-4 rounded mt-[12px] grid grid-cols-4 gap-4">
                        ...
                        <div class="col-span-2 text-xs">Người thuê: Trần Văn Bình</div>
                        ...
                        <div class="col-span-2 text-xs text-right">Giá hằng tháng: 7.000.000 VNĐ</div>
                ...
                <div class="mt-4 border-2 rounded p-4">
                    <div class="grid grid-cols-6 gap-4">
                        <div class="text-sm col-span-3 ">Thời hạn: 12 Tháng</div>
                        <div class="text-sm col-span-3 ">Tổng tiền nhà: 13.000.000 VNĐ</div>
                        <div class="text-sm col-span-2 ">Số điện: 1200 - 1500</div>
                        <div class="text-sm col-span-2 ">Số lượng: 300</div>
                        <div class="text-sm col-span-2 ">Tổng: 12.000.000 VNĐ</div>
                        <div class="text-sm col-span-2 ">Số nước: 1200 - 1500</div>
                        <div class="text-sm col-span-2 ">Số lượng: 300</div>
                        <div class="text-sm col-span-2 ">Tổng: 12.000.000 VNĐ</div>
                        <div class="text-sm col-span-6 ">Các dịch vụ khác: 4.800.000 VNĐ</div>
                        <div class="text-md col-span-6 ">Tổng cộng: 130.000.000</div>
                    </div>
                </div>
