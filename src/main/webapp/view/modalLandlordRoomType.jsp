    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        <div class="relative bg-white rounded shadow">
            ...
            <div class="p-4">
                ...
                <p class="mt-[10px] ml-[165px] text-[14px] italic font-light text-gray-700 ">VD: A101, B102, S510 ...</p>
                <div class="grid justify-items-end">
                    <button type="button" onclick="addRoom()" class="addRoom px-8 py-2 mx-4 my-2 rounded text-white bg-[#17535B] hover:bg-[#13484F]">Thêm</button>
                </div>
            </div>
        </div>
    </div>
