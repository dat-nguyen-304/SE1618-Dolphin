                    ...
                    <div class="card relative overflow-x-auto bg-[#fff] p-5 w-full">
                        ...
                        <table id = "invoice-detail-table" class="w-full text-[14px] text-left text-gray-500 mb-[20px]">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.detailList}" var="detail">
                                    <tr>
                                        ...
                                        <td scope="col" class="px-6 py-3">
                                            <c:if test="${detail.service.type == 1}">
                                        ...
                                        <td scope="col" class="px-6 py-3">
                                            <c:choose>
                                                <c:when test="${detail.service.type == 1}">
                                ...
                                <!--<td><input type="checkbox" class="useCheckBox" checked="" onclick="enableInput(${detail.service.serviceID})"></td>-->
                                <td scope="col" class="px-6 py-3"><span class="rowSum money"
                                                                        id="rowSum${detail.service.serviceID}">${detail.quantity * detail.service.serviceFee}</span>
                                </td>
                                </tr>
                            </c:forEach>
