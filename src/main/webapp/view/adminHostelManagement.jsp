        ...
        <div class="ml-[256px] my-0 h-fit overflow-hidden bg-[#f9fafb]">
            ...
            <div class="h-full px-[20px] pt-[calc(60px+20px)] pb-[20px]">
                ...
                <div class="card bg-[#fff] general-info p-[20px] mt-[20px] h-[calc(100vh-225px)]">
                    <table id="hostel-table" class="w-full text-[16px] text-left text-gray-600 border-[1px] border-gray-100 relative">
                        ...
                        <tbody>
                            <c:forEach items = "${requestScope.hostelList}" var = "hostel">
                                <tr class="bg-white border-b hover:bg-gray-50">
                                    <td scope="row" class="text-left px-6 py-[5px] font-medium text-gray-900">${hostel.hostelID}</td>
                                    ...
                                    <td class="text-center px-6 py-[5px]">${hostel.registeredDate}</td>
                                    ...
                                    <td class="text-left px-6 py-[5px] flex items-center justify-around">
                                        ...
                                        <form action="/sakura/admin/hostel-detail">
                                            <button name="hostelID" value="${hostel.hostelID}" class="w-[120px] text-center bg-[#fff] border border-gray-300 hover:border-[#17535B] text-gray-500 py-[3px] font-medium rounded">
