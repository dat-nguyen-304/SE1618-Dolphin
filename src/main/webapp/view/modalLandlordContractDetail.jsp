    ...
    <div class="modal-container bg-white w-3/12 mx-auto rounded shadow-lg z-50 overflow-y-auto">
        ...
        <div class="modal-content">
            ...
            <div class="flex justify-between items-center p-[20px] py-[10px] border-b">
                <p class="text-2xl font-bold">Kết thúc hợp đồng</p>
...
<div class="endContractmodal2 opacity-0 pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center z-[1000]">
    <div class="modal-overlay absolute w-full h-full bg-gray-900 opacity-50"></div>
