                            ...
                            <c:if test="${requestScope.chosenRoom != null}">
                                <form action="/sakura/invoice/save" class="invoice-detail " method="POST" id="invoice-form">
                                    ...
                                    <div class="invoice-detail-info mt-[20px] ">
                                        ...
                                        <c:if test="${requestScope.chosenRoom != null}">
                                            <span>Phòng: </span>
                                            <button class="ml-[20px] inline-block text-white bg-[#17535B] hover:bg-[13484F] font-medium rounded text-sm px-5 py-2.5 text-center" type="button">
                                                <span id="roomNumber">
                                    ...
                                    <div class="invoice-time-info mt-[30px] grid grid-cols-12">
                                        <div class="flex items-center col-span-4 grid grid-cols-6">
                                            <label for="invoice-month" class="col-span-2 text-[15px] text-gray-900 font-normal flex items-center">Kỳ thanh toán: </label>
                                    ...
                                    <div class="table-extend flex justify-between items-center mt-[30px]">
                                        ...
                                        <div class="summary w-1/2 grid grid-cols-8">
                                            <div class="col-span-2 text-[20px] text-[#17535B] font-bold">Thành tiền</div>
                                        ...
                                        <div id="roomList" class="mt-[30px] flex flex-wrap">
                                            <c:forEach var="room" items="${requestScope.noInvoiceList}">
                                                <form method="post" action="/sakura/invoice/new" style="display: inline-block;">
                                                    <button class="roomNoInvoice mb-[20px] mr-[20px] inline-block text-white bg-[#17535B] hover:bg-[13484F] font-medium rounded text-sm px-5 py-2.5 text-center"
